...
QUES.5)
import numpy as np
rainfall = np.array([120, 85, 150, 200, 175, 90,
                     110, 160, 210, 180, 95, 130])
...
print(df[df['Average'] > 75][['Name', 'Average']])
...
print("\nStudents below 80%:")
print(df[df['Attendance %'] < 80][['Name', 'Attendance %']])
...
average = df.groupby('Category')['Rating'].mean()
print("Category Average Rating:")
print(average)
highest = average.idxmax()
highest_rating = average.max()
print("\nHighest Rated Category:")
print(highest, f"{highest_rating:.2f}")
